...
function StaffProfile() {
  ...
  const fallbackAvatar = 'https://ui-avatars.com/api/?name=Staff&background=0D8ABC&color=fff'
      ...
      <div className="p-6 lg:p-10 w-full pb-24 lg:pb-10">
        <header className="mb-xl">
          ...
          <p className="text-body-base text-on-surface-variant max-w-2xl">
            Update your staff account details, profile photo, and password.
          </p>
        </header>
          ...
          <div className="xl:col-span-4">
            <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-lg shadow-sm">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-body-sm text-outline">{profile.role}</p>
                <p className="text-body-sm text-on-surface-variant mt-1">Joined {formatJoinedDate(profile.createdAtUtc)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="xl:col-span-8 space-y-gutter">
            <section className="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden shadow-sm">
              <div className="px-lg py-md border-b border-outline-variant bg-surface-container-low flex items-center gap-2 text-primary">
                ...
                <h3 className="font-h3 text-h3">Staff Information</h3>
              </div>
              <div className="p-lg">
                <form className="grid grid-cols-1 md:grid-cols-2 gap-lg">
                  <label className="space-y-sm">
                    ...
                    <input className="w-full h-[44px] rounded-lg border border-outline-variant bg-surface-container-low focus:border-primary focus:ring-1 focus:ring-primary px-3" value={profile.name} onChange={(e) => setProfile((prev) => ({ ...prev, name: e.target.value }))} />
                  </label>
                  <label className="space-y-sm">
                    <span className="font-label-caps text-on-surface-variant">Email</span>
                    <input className="w-full h-[44px] rounded-lg border border-outline-variant bg-surface-container-low focus:border-primary focus:ring-1 focus:ring-primary px-3" type="email" value={profile.email} onChange={(e) => setProfile((prev) => ({ ...prev, email: e.target.value }))} />
                  </label>
                  <label className="space-y-sm">
                    <span className="font-label-caps text-on-surface-variant">Phone</span>
                    <input className="w-full h-[44px] rounded-lg border border-outline-variant bg-surface-container-low focus:border-primary focus:ring-1 focus:ring-primary px-3" value={profile.phone} onChange={(e) => setProfile((prev) => ({ ...prev, phone: e.target.value }))} />
                  </label>
                  <label className="space-y-sm">
                ...
                <form className="space-y-lg w-full">
                  <label className="space-y-sm block">
                    ...
                    <div className="relative">
                      <input className="w-full h-[44px] rounded-lg border border-outline-variant bg-surface-container-low focus:border-primary focus:ring-1 focus:ring-primary px-3 pr-12" type="password" value={password.current} onChange={(e) => setPassword((prev) => ({ ...prev, current: e.target.value }))} />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-lg">
                    <label className="space-y-sm">
                      ...
                      <input className="w-full h-[44px] rounded-lg border border-outline-variant bg-surface-container-low focus:border-primary focus:ring-1 focus:ring-primary px-3" type="password" value={password.next} onChange={(e) => setPassword((prev) => ({ ...prev, next: e.target.value }))} />
                    </label>
                    <label className="space-y-sm">
                      <span className="font-label-caps text-on-surface-variant">Confirm New Password</span>
                      <input className="w-full h-[44px] rounded-lg border border-outline-variant bg-surface-container-low focus:border-primary focus:ring-1 focus:ring-primary px-3" type="password" value={password.confirm} onChange={(e) => setPassword((prev) => ({ ...prev, confirm: e.target.value }))} />
                    </label>
                  </div>
